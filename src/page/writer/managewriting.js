...
const Managewriting = () => {
    ...
    const handleCheckboxChangeAll = () => {
        const allNovelIds = novelsData.map(novel => novel.id);
    ...
    <div>
        ...
        <Container  style={{width:'65%'}}>
            ...
            {novelsData.map((novel) => (
                <a href="/managechapter" className="whole-div-link">
                    ...
                    <div className='container-left'>
                        <div className='checkbox-con'>
                            <Form.Check
                                ...
                                className="custom-checkbox"
                                value={novel.id}
                                checked={checkedNovels.has(novel.id)}
                                onChange={() => toggleCheckbox(novel.id)}  
                            />
                        </div>
                        <img src={novel.imageUrl}  alt="imgnovel" className='novel-img-manage'/>
                        <div className='describe-con'>
                            ...
                            <div className = 'describe grey'>
                                {novel.chapterCount} <img src="https://1146890965.rsc.cdn77.org/web/newux/assets/images/icon-amount-chapter@3x.png?t_144" className='icon-manage' alt='chaptercountimg'/> 
                                {novel.views} <RemoveRedEyeIcon className='icon-manage' style={{color:'#8d8d92'}}></RemoveRedEyeIcon>
                                {novel.rating} <img src="https://1146890965.rsc.cdn77.org/web/newux/assets/images/heart_darkgrey.png?t_144" className='icon-manage' alt='ratingimg'/>
                            </div>
                        </div>
                    </div>
