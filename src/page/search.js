                                                    ...
                                                    <div className='d-flex flex-column justify-content-between' style={{ height: "100%" }} >
                                                        <div>
                                                            <a href={`/readnovel/${novel.novel_id}`} className='no-underline'>
                                                                <Card.Subtitle>{novel.novel_name.length > 20 ? `${novel.novel_name.slice(0, 20)}...` : novel.novel_name}</Card.Subtitle>
                                                            </a>
                                                        </div>
                                                        <div>
                                                            {novel&&<a href={`/novel/${novel.penname}`} className='no-underline author'>
                                                                <Card.Subtitle className="mt-1">{novel.penname&&novel.penname.length>15? `${novel.penname.slice(0, 15)}...` : novel.penname}</Card.Subtitle>
